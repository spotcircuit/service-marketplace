  ...
  const faqs = [
    {
      ...
      answer:
        'Our size calculator helps you choose based on your project type. Generally: 10-yard for small cleanouts, 15-yard for renovations, 20-yard for large projects.',
    },
    {
      question: 'Do I need a permit for a dumpster?',
      answer:
        "Permits are typically only required if placing the dumpster on public property (street). Driveway placement usually doesn't require permits.",
    },
    {
      question: 'How much does a dumpster rental cost?',
      answer:
        'Prices start at $295 for a 10-yard dumpster with 7-day rental. Final cost depends on size, location, and debris type.',
    },
    {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-hero-foreground">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Dumpster Rental for Homeowners</h1>
              <p className="text-xl mb-8 text-hero-foreground/90">
                Simple, affordable waste removal for home projects. From small cleanouts to major renovations, we
                make it easy to get rid of your debris.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {residentialSizes.map((item) => (
              ...
              >
                {item.recommended && (
                  <span className="absolute -top-3 left-6 px-3 py-1 bg-green-600 text-white text-sm rounded-full">Most Popular</span>
                )}
                <div className="mb-4">
          ...
          <div className="text-center mt-8">
            <Link href="/dumpster-sizes" className="inline-flex items-center gap-2 text-primary hover:text-primary/80 font-medium">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Use our calculator or call for expert sizing advice</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Pick your date, we'll deliver to your driveway</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Take your time - you have 7 days included</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">Call for pickup, we handle disposal properly</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-gray-300">Download our free guides to make your project easier</p>

          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800 rounded-lg p-6">
              <Download className="h-8 w-8 text-primary mx-auto mb-3" />
              <h3 className="font-semibold mb-2">Project Checklist</h3>
              <p className="text-sm text-gray-400 mb-3">Step-by-step guide for your rental</p>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-400 mb-3">Find the perfect size for your project</p>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-400 mb-3">Compare costs and save money</p>
              <a href="#" className="text-primary hover:text-primary/80 text-sm font-medium">
                View Guide →
              </a>
            </div>
          ...
          <p className="text-gray-400 text-sm">Join 15,000+ homeowners who receive our weekly tips newsletter</p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-primary">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="mt-6 text-white/80 text-sm">96% customer satisfaction • 3,200+ providers • 150+ cities served</p>
        </div>
      </section>
