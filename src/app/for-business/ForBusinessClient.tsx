...
export default function ForBusinessClient(): JSX.Element {
  const benefits = [
    {
      icon: TrendingUp,
      title: 'Increase Visibility',
      description:
        'Get found by thousands of customers actively searching for your services',
    },
    {
      icon: Users,
      title: 'Quality Leads',
    ...
    },
    {
      ...
      description:
        'Showcase reviews and build trust with verified business status',
    },
    {
      icon: BarChart,
      title: 'Track Performance',
      description:
        'Monitor views, leads, and conversions with detailed analytics',
    },
  ] as const;
  ...
  const testimonials = [
    {
      ...
      quote:
        'Since upgrading to featured listing, our leads have increased by 300%. The ROI is incredible!',
      rating: 5,
    },
    {
      name: 'Sarah Johnson',
      ...
      image: 'https://ext.same-assets.com/1079325698/1963887577.webp',
      quote:
        'The platform has been a game-changer for our business. We get quality leads every day.',
      rating: 5,
    },
    {
      name: 'Mike Chen',
      ...
      image: 'https://ext.same-assets.com/1079325698/1963887577.webp',
      quote:
        "Best investment we've made in marketing. The leads are high quality and ready to book.",
      rating: 5,
    },
  ] as const;
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link
                href="/claim"
                className="px-8 py-4 bg-white text-primary rounded-lg hover:bg-white/90 font-semibold text-lg"
              >
                Get Started Free
              </Link>
              <Link
                href="/claim"
                className="px-8 py-4 bg-white/20 text-white rounded-lg hover:bg-white/30 backdrop-blur font-semibold text-lg border border-white/30"
              >
      ...
      <div id="features" className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-card rounded-lg border p-6">
            ...
            <p className="text-muted-foreground">
              Get priority placement in search results and category pages
            </p>
          </div>
          <div className="bg-card rounded-lg border p-6">
            ...
            <p className="text-muted-foreground">
              Receive and manage leads directly from your dashboard
            </p>
          </div>
          <div className="bg-card rounded-lg border p-6">
          ...
          <div className="bg-card rounded-lg border p-6">
            ...
            <p className="text-muted-foreground">
              Showcase your ratings and build social proof
            </p>
          </div>
          <div className="bg-card rounded-lg border p-6">
            ...
            {testimonials.map((testimonial, i) => (
              <div key={i} className="bg-card rounded-lg p-6">
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonials[i].rating)].map((_, j) => (
                    <Star
                      key={j}
