...
const categories: ItemCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        disposal: 'Licensed asbestos removal provider'
      },
      {
        name: 'Medical Waste',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        disposal: 'HVAC professional or special disposal'
      },
      {
        name: 'Washers & Dryers',
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center mb-4">
                <Recycle className="h-6 w-6 text-primary mr-3" />
      ...
      <section className="py-16 px-4 bg-primary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            ...
            className="inline-flex items-center px-8 py-3 bg-white text-primary rounded-lg font-medium hover:bg-primary/10 transition"
          >
            Get Free Quotes
          </button>
        </div>
