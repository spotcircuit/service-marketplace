...
export async function generateMetadata(): Promise<Metadata> {
  return generateSEO({
    pageType: 'guide',
    title: 'Dumpster Rental Resources & Guides - Everything You Need to Know',
    description: 'Complete resource center for dumpster rentals. Find size calculators, cost estimators, rental guides, FAQs, and expert tips for your project.',
      ...
      resources: [
        {
          ...
          href: '/resources/size-calculator',
          icon: Ruler
        },
        {
