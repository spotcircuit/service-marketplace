      ...
      <section className="bg-gradient-to-r from-green-600 to-green-700 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-green-100">
            Current market rates and cost factors explained
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            ...
            <div className="mt-6 p-4 bg-green-100 rounded-lg text-center">
              <p className="text-sm text-green-700 mb-2">Estimated Cost</p>
              <p className="text-4xl font-bold text-green-900">
                ${calculatePrice()}
              </p>
              <p className="text-sm text-green-600 mt-2">
                Base price adjusted for your selections
              </p>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2">•</span>
                    <span className="text-gray-700">
                      <strong>Get multiple quotes:</strong> Prices can vary 20-30% between companies
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-16 px-4 bg-green-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-green-100 mb-8">
            Compare real quotes from local providers
          </p>
          <Link
            href="/"
